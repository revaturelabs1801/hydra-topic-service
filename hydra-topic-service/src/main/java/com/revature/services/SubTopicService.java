...
public class SubTopicService {
	...
	public SubTopicService(SubtopicRepository subtopicRepository, SubtopicNameRepository subtopicNameRepository,
			SubtopicStatusRepository subtopicStatusRepository, SubtopicTypeRepository subtopicTypeRepository) {
		super();
	...
	/*
	 * public List<Subtopic> getSubtopicByBatchId(int batchId) { return
	 * subtopicRepository.findByBatch(batchRepository.findByid(batchId)); }
	 */
